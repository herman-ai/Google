...
private static final String HADOOP_CONF = "/Users/hermansahota/ibm-eclipse-workspace/systemml-pmml/";
...
config.addResource(new Path(HADOOP_CONF + "core-site.xml"));
config.addResource(new Path(HADOOP_CONF + "hdfs-site.xml"));
config.addResource(new Path(HADOOP_CONF + "mapred-site.xml"));
...
Configuration config = new Configuration();
//config.addResource(HADOOP_CONF + "core-site.xml");
//config.addResource(HADOOP_CONF + "hdfs-site.xml");
//config.addResource(HADOOP_CONF + "mapred-site.xml");

config.set("fs.default.name", "hdfs://hdtest167.svl.ibm.com:9000");
...
conf.addResource(new Path(HADOOP_CONF + "mapred-site.xml"));
